      ...
      $(('.card'+index)+ ' .4').text(foreCastDataList[index].main.humidity);
         ...
         */
          ...
          for (let index = 0; index < data.length; index++) {
           ...
           if(data[index].OperatorInfo!=null)
          {
           $(('.charger-card'+index)+ ' .6').text((data[index].OperatorInfo.Title));
           }


           if (data[index].NumberOfPoints===null || data[index].UsageCost===null)
          {
          ...
          else
          {
           ...
           $(('.charger-card'+index)+ ' .7').text((data[index].NumberOfPoints));
           $(('.charger-card'+index)+ ' .8').text((data[index].UsageCost));
    ...
    .then(function(data){
      //  console.log(citiName);
       ...
       // console.log(data);
        ...
        //console.log((((data.main.temp- 273.15) * 9/5) + 32).toFixed(0)+"°F");
        //console.log(data.main.humidity);
        $('.weather-detail h2').text(citiName.toUpperCase()+" ("+currentDate+")");
        $('.2').text((((data.main.temp- 273.15) * 9/5) + 32).toFixed(0)+"°F");
        $('.3').text(data.wind.speed);
        $('.4').text(data.main.humidity);
        $('img').attr('src',`https://openweathermap.org/img/wn/${data.weather[0].icon}@4x.png`);
...
>>>>>>> f248852f99b1f53f8d0cb3512975a9cc7f8c0812
